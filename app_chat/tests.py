...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='usuario1' ,password='pass01')
        self.usuario_b = User.objects.create(username='usuario2' ,password='pass02')
        self.usuario_c = User.objects.create(username='usuario3' ,password='pass03')
        
    def test_usuarios_count(self):
        qs = User.objects.all()
    ...
    def test_dos_usuario(self):
        ...
        CanalUsuario.objects.create(usuario=self.usuario_c, canal=canal_obj_2)
